        ...
        </button>
        {
          this.props.list.map((item, index) => (
            <button
              ...
              onDoubleClick={this.handleOnDoubleClick}
              style={{
                transform: "rotate("+((360/this.props.list.length)*index)+"deg) translate(175px) rotate("+(-(360/this.props.list.length)*index)+"deg) translate(200px, 200px) translate(-50%, -50%)",
